...
bool create_exe (bin_tree *tree, FILE *exe_file, variables *var)
{
    ...
    size_t sizeof_headers = sizeof(IMAGE_DOS_HEADER) + sizeof(DOS_STUB) + sizeof(IMAGE_NT_HEADERS32) + 3 * sizeof(IMAGE_SECTION_HEADER);
...
void fill_NT_header (IMAGE_NT_HEADERS32 *NT_header, int NUM_OF_SEC)
{
...
void fill_NT_optional_header (IMAGE_OPTIONAL_HEADER32 *NT_optional_header)
{
