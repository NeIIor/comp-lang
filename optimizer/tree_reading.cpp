...
bin_tree_elem *fill_tree (text_t *text, variables *var)
{
    ...
    else if (strncmp(text->counter, "$arcctg", 7) == 0 && !isalpha(*(text->counter + 7)))
        CREATE_TREE_ELEM(FUNC, ARCCTG, 7)
    else if (strncmp(text->counter, "$sh", 3)     == 0 && !isalpha(*(text->counter + 3)))
        CREATE_TREE_ELEM(FUNC, SH, 3)
    else if (strncmp(text->counter, "$ch", 3)     == 0 && !isalpha(*(text->counter + 3)))
        CREATE_TREE_ELEM(FUNC, CH, 3)
    else if (strncmp(text->counter, "$th", 3)     == 0 && !isalpha(*(text->counter + 3)))
        CREATE_TREE_ELEM(FUNC, TH, 3)
    else if (strncmp(text->counter, "$cth", 4)    == 0 && !isalpha(*(text->counter + 4)))
        CREATE_TREE_ELEM(FUNC, CTH, 4)
    ...
    else if (strncmp(text->counter, "$exp", 4)    == 0 && !isalpha(*(text->counter + 4)))
        CREATE_TREE_ELEM(FUNC, EXP, 4)
